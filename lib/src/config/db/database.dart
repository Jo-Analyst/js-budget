  ...
  static Future<sql.Database> openDatabase() async {
    ...
    return sql.openDatabase(
      ...
      onCreate: (db, version) {
        ...
        db.execute(
          "CREATE TABLE IF NOT EXISTS budgets (id INTEGER PRIMARY KEY, value_total REAL NOT NULL, status TEXT DEFAULT 'Em aberto', created_at TEXT, freight REAL, payment_method TEXT, order_id INTEGER NOT NULL, client_id INTEGER NOT NULL, FOREIGN KEY (order_id) REFERENCES orders(id) ON DELETE SET NULL, FOREIGN KEY (client_id) REFERENCES clients(id) ON DELETE SET NULL)",
        );
